...
- Run the following commands and ensure we get a 0000 return code:
  - `zowe endevor generate element DOGGOS25 --type COBOL --os --maxrc 0 --sn 1 --cb`
  - `zowe endevor generate element DOGGOS25 --type LNK --os --maxrc 0 --sn 1 --cb`
...
`zowe jobs submit data-set "CUST025.PUBLIC.JCL(NDRUNDOG)" --vasc`
...
The repository URL will be `https://github.com/McQuitty-Broadcom/Python-DevOps-25.git`
